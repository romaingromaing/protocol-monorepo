...
declare module 'hardhat/types/runtime' {
    ...
    export interface HardhatRuntimeEnvironmentContext {
        env: HardhatRuntimeEnvironment
        restoreContext: () => void
    }

    export interface HardhatRuntimeEnvironment {
        buildHardhatRuntimeEnvironmentForWorkspace(workspace: string, network: string): HardhatRuntimeEnvironmentContext
        runInHardhatRuntimeEnvironment<T>(env: HardhatRuntimeEnvironment, fn: () => T): Promise<T>
    }
}
