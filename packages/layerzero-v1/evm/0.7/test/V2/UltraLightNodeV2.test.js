...
describe('UltraLightNodeV2:', function () {
    ...
    let user1,
        ...
        lzToken,
        relayerWithdraw;
    let { outboundProofType, zroFee, txParams, adapterParams, defaultBlockConfirmations, emptyBytes32 } = VARS;
    let v2 = true;
...
describe('Max Library Version:', function () {
    ...
    beforeEach(async function () {
        ...
        ({
            ...
            await wireEndpoints(
                [await generateVersion(endpoints[0], chainIds, outboundProofType, 1, false, v2)],
                true,
                v2
            )
        )[0]);
