...
export interface Endpoint extends BaseContract {
  ...
  functions: {
    ...
    newVersion(
      _newLayerZeroLibraryAddress: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    setDefaultReceiveVersion(
      _newDefaultReceiveVersion: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

    setDefaultSendVersion(
      _newDefaultSendVersion: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
