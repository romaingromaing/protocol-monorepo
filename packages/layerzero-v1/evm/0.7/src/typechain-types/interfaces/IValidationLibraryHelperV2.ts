...
export declare namespace IValidationLibraryHelperV2 {
...
export interface IValidationLibraryHelperV2Interface extends utils.Interface {
  functions: {
    "getPacket(bytes,uint256,bytes32)": FunctionFragment;
...
export interface IValidationLibraryHelperV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IValidationLibraryHelperV2Interface;
  ...
  functions: {
    ...
    getVerifyLog(
      ...
      overrides?: CallOverrides
    ): Promise<[IValidationLibraryHelperV2.ULNLogStructOutput]>;
  };
